...
//+kubebuilder:rbac:groups=exoscale.k8s.io,resources=exoscaleclusterproviderspecs;exoscaleclusterproviderstatuses,verbs=get;list;watch;create;update;patch;delete
func init() {
