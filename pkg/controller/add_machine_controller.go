...
//+kubebuilder:rbac:groups=exoscale.k8s.io,resources=exoscalemachineproviderspecs;exoscalemachineproviderstatuses,verbs=get;list;watch;create;update;patch;delete
func init() {
